      ...
      <div className="relative">
        ...
        <div className="absolute z-20 bottom-10 md:bottom-20 left-0 w-full flex justify-center md:justify-start px-4 sm:px-8 md:px-12 lg:px-20 gap-4">
          ...
          <button
            ...
            className="bg-orange-500 px-6 py-3 text-white font-bold rounded-lg shadow-lg
                       hover:bg-orange-600 hover:scale-105 transition duration-200 text-sm sm:text-base"
          >
            Apply Now
          </button>
          ...
          <Link
            to="/careers"
            className="bg-white/10 backdrop-blur-md border border-white/30 px-6 py-3 text-white font-bold rounded-lg
                       hover:bg-white hover:text-black transition duration-200 text-sm sm:text-base"
          >
            Back to All Jobs
          </Link>

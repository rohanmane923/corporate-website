    ...
    <footer className="bg-[#0c2438] text-white pt-12 pb-6">
      ...
      <div className="w-full max-w-7xl mx-auto px-8 sm:px-12 lg:px-20 grid md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col items-start">
          ...
          {/* Logo Box */}
          <div className="bg-white rounded-2xl p-1 mb-6 w-20 h-15 flex items-center justify-center">
            <img
              src={logo}
              alt="logo"
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link to="/news/blogs" className="hover:text-orange-400">Blogs / Insights</Link></li>
            <li><Link to="/sectors/logistics/case-studies" className="hover:text-orange-400">Case Studies</Link></li>
